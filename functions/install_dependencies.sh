...
install_dependencies () {
	sudo apt-get -y install git nano ntp ntpdate nginx php8.2-fpm php8.2-common php8.2-mbstring php8.2-xmlrpc php8.2-gd php8.2-xml php8.2-mysql php8.2-cli php8.2-zip php8.2-curl php8.2-soap php8.2-intl php8.2-ldap mariadb-server mariadb-client unzip 1>>$logfile 2>>$errlog
	printf -- "\e[90mLes dépendances suivantes ont été installées: git nano ntp ntpdate nginx php8.2-fpm php8.2-common php8.2-mbstring php8.2-xmlrpc php8.2-gd php8.2-xml php8.2-mysql php8.2-cli php8.2-zip php8.2-curl php8.2-soap php8.2-intl php8.2-ldap mariadb-server mariadb-client unzip\e[22m"
}
install_dependencies
echo ""
